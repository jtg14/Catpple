				...
				<div class="row" id="main"
					...
					<div class="col-sm-12 col-md-12" id="content"
						...
						<div class="col-md-10 col-xs-12">
							...
							<c:forEach var="rList" items="${returnedList}">
								<div class="container text-center"
									style="border-top: 2px solid lightgray; padding-top: 10px; padding-bottom: 10px;">
									<div class="col-md-3 col-xs-12">
										<img class="img" src="resources/sellerInfo/${rList.sellerID}/${rList.gImg1}">
									</div>
									...
									<div class="col-md-2 col-xs-12">
										...
										<div class="col-md-12 col-xs-6"
											...
											<span style="font-weight: bold; color: crimson;">${rList.oStatus}</span>
										</div>
