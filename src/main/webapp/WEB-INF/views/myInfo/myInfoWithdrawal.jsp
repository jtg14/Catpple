						...
						<div class="col-md-10 col-xs-12">
							...
							<div
								...
								<ul style="font-size: medium;">
									<li>고객님께서 회원 탈퇴를 원하신다니 저희 The CatHouse의 서비스가 많이 부족하고 미흡했나
										봅니다.</li>
									<li>불편하셨던 점이나 불만사항을 알려주시면 적극 반영해서 고객님의 불편함을 해결해 드리도록
										노력하겠습니다.</li>
									...
									<li>회원탈퇴 후 등록하신 상품문의 및 후기, 댓글은 삭제되지 않으며, 회원정보 삭제로 인해 작성자
										본인을 확인할 수 없어 편집 및 삭제처리가 원천적으로 불가능 합니다.</li>
