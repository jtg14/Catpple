		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row" id="main"
					...
					<form action="goodsInsert" id="addGoodsForm" method="post" enctype="multipart/form-data">
									<!-- row2 상품번호/카테고리 코드 -->
									<div class="row">
										<div style="width: 100%;">
											<h3>상품 정보</h3>
									...
									<button type="submit" class="btn btn-primary btn-md" id="gis"
										onclick="return checkfile()">상품 등록</button>
								</form>
							</div>
						</div>
					</div>
